...
public class Ex46 {
    public static void main(String[] args) {
        ...
        System.out.print("Введите Римское число от  I and MMMMCMXCIX: ");
        String romanYear = scanner.nextLine();
        int num = romanToArabic(romanYear.toUpperCase());
        System.out.println("Арабский аналог " + romanYear + " : " + num);
    }
    ...
    private static int romanToArabic(String romanYear) throws IllegalArgumentException {
        ...
        if (num <= 0 || num >= 10000) {
            throw new IllegalArgumentException("Числа должны быть от I and MMMMCMXCIX");
        }
        return num;
    }
    ...
    private static int getValue(String[] symbols, int[] values, String symbol) throws IllegalArgumentException {
        ...
        throw new IllegalArgumentException("Неправильное римское число! " + symbol);
    }
}